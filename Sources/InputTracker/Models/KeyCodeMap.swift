...
enum KeyCodeMap {
    private static let map: [UInt16: String] = [
        ...
        UInt16(kVK_Command): "Cmd",
        UInt16(kVK_Shift): "Shift",
        UInt16(kVK_CapsLock): "CapsLock",
        UInt16(kVK_Option): "Option",
        UInt16(kVK_Control): "Control",
        UInt16(kVK_RightCommand): "RCmd",
        UInt16(kVK_RightShift): "RShift",
        UInt16(kVK_RightOption): "ROption",
        UInt16(kVK_RightControl): "RControl",
        UInt16(kVK_F1): "F1",
        UInt16(kVK_F2): "F2",
        UInt16(kVK_F3): "F3",
        UInt16(kVK_F4): "F4",
        ...
        UInt16(kVK_ForwardDelete): "FwdDel",
